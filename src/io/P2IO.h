...
private:
	...
	static uint8_t p2io_request[256];
	static uint8_t p2io_response[256];
	static serial::Serial com4;
    
    static bool COM4SET;
    
    static const uint16_t P2IO_VENDOR_ID = 0x0000;
    static const uint16_t P2IO_PRODUCT_ID = 0x7305;
    
    static uint8_t pchunk[3][4];
    static uint8_t p_light_payload[];
    static int interrupt_ep;
    static int bulk_write_to_ep;
    static int bulk_read_from_ep;
    static bool m_bConnected;
    static char debug_message[2048];
    static int bulk_reply_size;
    static bool baud_pass;
    static bool hdxb_ready;
};
